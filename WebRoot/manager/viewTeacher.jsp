...
<div class="navbox">
  <div class="nav">
    ...
    <div class="middle">
      ...
      <!-- 查看所有学生信息 -->
        <form action="find_teacher" method="post">
   ...
   <!-- 删除学生信息 -->
      ...
      <s:iterator value="teachers">
        <tr>
          <td><s:property value="teaNum" /></td>
          <td><s:property value="teaName" /></td>
          <td><s:property value="teaSex" /></td>
          <td><s:property value="teaProTitle" /></td>
          <td><s:property value="teaDegree" /></td>
          <td><s:property value="teaContactWay" /></td>
          <td><a
