...
<div class="navbox">
  <div class="nav">
    <ul class="clearfix">
      ...
      <li class="drop-menu-effect"> <a target="-self" href="#"><span>课程信息</span></a>
        <ul class="submenu">
          <li><a href="addCourse.jsp">查看课程信息</a></li>
          <li><a href="viewCourses.jsp">查看授课课程信息</a></li>
        </ul>
      </li>
      ...
      <li class="drop-menu-effect"> <a target="-self" href="#"><span>考试安排</span></a>
        <ul class="submenu">
          ...
          <li><a href="viewExam.jsp">查看课程考试安排表</a></li>
        </ul>
      </li>
