...
public class Teacher  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Teacher(String teaName, String teaSex, Short teaAge, Date teaBirth, String teaMinority, String teaDegree, String teaProTitle, Boolean type) {
    ...
    /** full constructor */
    public Teacher(String teaName, String teaSex, Short teaAge, Date teaBirth, String teaMinority, String teaDegree, String teaProTitle, String teaContactWay, String teaPassword, Boolean type, Set courseSelections, Set courses) {
        this.teaName = teaName;
        this.teaSex = teaSex;
        this.teaAge = teaAge;
        this.teaBirth = teaBirth;
