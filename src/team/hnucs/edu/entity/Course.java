...
public class Course  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Course(String courNum, Teacher teacher, String courName, Short courLimitedNum, Date courStartDate, Boolean courCredits, String courType) {
    ...
    /** full constructor */
    public Course(String courNum, Teacher teacher, String courName, Short courLimitedNum, Date courStartDate, Boolean courCredits, String courType, Short choosedNum, Boolean courseSemester, Set scores, Set examArrangements, Set courseSelections) {
        this.courNum = courNum;
        this.teacher = teacher;
        this.courName = courName;
        this.courLimitedNum = courLimitedNum;
